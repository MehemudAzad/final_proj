        ...
        <div className='mx-auto bg-white'>
                ...
                <label className="label">
                 ...
                 <select name="category" className="select select-bordered w-full bg-slate-200">
                    ...
                    <option>DS & Algorithms</option>
                    <option>Programming Languages</option>
                    <option>Machine Learning</option>
                    <option>Interview & Placement</option>
                ...
                <label className="label">
                 ...
                 <select name="type" className="select select-bordered w-full bg-slate-200">
                    <option disabled selected>What type of course is this?</option>
                    <option>Live</option>
                    <option>Free</option>

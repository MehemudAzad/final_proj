    ...
    <div className="card rounded-lg flex flex-col card-side shadow-2xl bg-green-200 hover:bg-blue-200">
      <figure className="rounded-none">
        {/**image_url? image_url : */}
        {
          ...
          <>
            <img
            className="h-[300px] rounded-t-lg z-100"
      ...
      <div className="card-body h-[300px] p-4">
        ...
        <div className="flex items-center gap-3">
          <div className="text-sm bg-blue-300 rounded-lg p-1">{course_type}</div>
          <div className="text-sm bg-blue-300 rounded-lg p-1">{category}</div>
        </div>
        <div className="flex card-action justify-between mt-3">
          <button className="text-black btn bg-blue-300 mr-4">
            Price : {course_price}
          </button>

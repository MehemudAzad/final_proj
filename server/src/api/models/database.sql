...
-- weak password trigger


CREATE OR REPLACE FUNCTION check_weak_password()
RETURNS TRIGGER AS $$
BEGIN
...
CREATE OR REPLACE TRIGGER weak_password
BEFORE INSERT ON users
FOR EACH ROW
EXECUTE FUNCTION check_weak_password();
...
CREATE OR REPLACE FUNCTION LAUNCH_COURSE ()
RETURNS TRIGGER AS $$
BEGIN 
...
CREATE OR REPLACE TRIGGER COURSE_LAUNCHING 
AFTER UPDATE ON COURSES 
FOR EACH ROW 
EXECUTE FUNCTION LAUNCH_COURSE(); 
